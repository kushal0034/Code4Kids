...
import { Sparkles, Play, RotateCcw, CheckCircle, Star, Home, ArrowLeft, Flame, Zap, Shield, Heart } from 'lucide-react';
      ...
      <div className="relative z-10 p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-80px)]">
        ...
        <div className="bg-black/20 backdrop-blur-sm rounded-3xl border border-red-500/30 p-6 flex flex-col max-h-full overflow-hidden">
          ...
          <div
            ...
            onDrop={handleDrop}
            className="flex-1 border-2 border-dashed border-red-500/30 rounded-xl p-4 min-h-32 max-h-64 overflow-y-auto bg-black/10"
          >
            {codeBlocks.length === 0 ? (
